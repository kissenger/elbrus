...
// Route analysis
export const ROTATION_RANGE_TOL = 135;       // a one-way route with a bearing range > this will be considered as rotational and return CW or ACW direction
export const CW_CIRC_THRESHOLD = 0.15;        // threshold below which a route is 'weakly rotational'; used to help identify circular routes
export const PC_THRESH_UPP = 40;             // if % shared points > PC_THRESH_UPP then consider as 'out and back' route
...
export const CW_TOLERANCE = 1        // tolernace below which change in bearing is neglected (eliminate noise)
export const BEARING_SECTIONS = 100   // number of sections to divide path into for bearing analysis


export const OUT_AND_BACK = 'Out and back';
export const CIRCULAR = 'Circular';
export const ONE_WAY = "One way";
export const NO_DIRECTION = "N/A";
export const ANTI_CLOCKWISE = "Anti-clockwise";
export const CLOCKWISE = "Clockwise";
export const NO_CATEGORY = "None";
export const FIGURE_OF_EIGHT = "Figure of eight";

// Jael setup
export const PATH_TO_GEOTIFFS = '../../../_ASTGTM/';
export const SIMPLIFICATION_FACTOR_PASS_1 = 2
export const SIMPLIFICATION_FACTOR_PASS_2 = 10
